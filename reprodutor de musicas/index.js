...
const songs = [
    {
        name: "SHIGURE UI",
        author: "9MM x LOLI",
        path: "./songs/9MM x LOLI SHIGURE UI.mp3"
    },
    {
        name: "Bad Romance",
        author: "Lady Gaga",
        path: "./songs/Lady Gaga - Bad Romance (Lyrics).mp3"
    },
    {
        name: "Star Power Remix Lobby Music (Season 5 Chapter 2)",
        author: "Fortnite",
        path: "./songs/Fortnite _ Star Power Remix Lobby Music (Season 5 Chapter 2).mp3",
    }
];
